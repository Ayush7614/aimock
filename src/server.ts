 ...
 * job/queue state, the ElevenLabs Voice Design store, the Gemini
 * interaction/event-id counters, and any runtime chaos override (reverting to
 * the construction-time chaos config), then re-zero the
